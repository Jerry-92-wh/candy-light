...
return array(
	...
	'content'    => '<!-- wp:columns {"align":"wide"} -->
					...
					<figure class="wp-block-image size-large is-resized"><img src="' . esc_url( get_template_directory_uri() ) . '/assets/images/Candyle-width.png" alt="' . esc_attr__( 'Illustration of a candle.', 'twentytwentytwo' ) . '" width="984" height="1426"/></figure>
					<!-- /wp:image --></div>
					<!-- /wp:column -->
