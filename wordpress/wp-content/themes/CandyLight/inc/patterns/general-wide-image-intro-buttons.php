...
return array(
	...
	'content'    => '<!-- wp:group {"align":"wide"} -->
				...
				<figure class="wp-block-image size-large is-resized"><img src="' . esc_url( get_template_directory_uri() ) . '/assets/images/Candyle-width.png" alt="' . esc_attr__( 'Illustration of a candle.', 'twentytwentytwo' ) . '" width="2100" height="994"/></figure>
				<!-- /wp:image -->
