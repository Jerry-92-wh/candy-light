...
return array(
	...
	'content'  => '<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"0px","bottom":"0px"}}},"layout":{"inherit":true}} -->
					...
					<figure class="wp-block-image alignfull size-full is-resized"><img src="' . esc_url( get_template_directory_uri() ) . '/assets/images/Candyle-width.png" alt="' . esc_attr__( 'Illustration of a candle.', 'twentytwentytwo' ) . '" width="2400" height="1020"/></figure>
					<!-- /wp:image -->',
);
